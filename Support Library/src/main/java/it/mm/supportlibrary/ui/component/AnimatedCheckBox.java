...
public class AnimatedCheckBox extends View implements Checkable {
    ...
    private int mWidth, mAnimDuration, mBorderStrokeWidth, mTickStrokeWidth;
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.AnimatedCheckBox);
        mTickColor = ta.getColor(R.styleable.AnimatedCheckBox_color_tick, COLOR_TICK);
        mAnimDuration = ta.getInt(R.styleable.AnimatedCheckBox_duration, DEF_ANIM_DURATION);
        mFloorColor = ta.getColor(R.styleable.AnimatedCheckBox_color_unchecked_stroke, COLOR_FLOOR_UNCHECKED);
        mCheckedColor = ta.getColor(R.styleable.AnimatedCheckBox_color_checked, COLOR_CHECKED);
        mUnCheckedColor = ta.getColor(R.styleable.AnimatedCheckBox_color_unchecked, COLOR_UNCHECKED);
        mBorderStrokeWidth = ta.getDimensionPixelSize(R.styleable.AnimatedCheckBox_border_stroke_width, dp2px(getContext(), 3));
        mTickStrokeWidth = ta.getDimensionPixelSize(R.styleable.AnimatedCheckBox_tick_stroke_width, dp2px(getContext(), 2));
        mSmallTick = ta.getBoolean(R.styleable.AnimatedCheckBox_small_tick, false);
        ta.recycle();
    ...
    public void setChecked(boolean checked) {
        ...
        invalidate();
        if (mListener != null) {
            mListener.onCheckedChanged(AnimatedCheckBox.this, mChecked);
        }
    }
    ...
    public void setmBorderStrokeWidth(int mBorderStrokeWidth) {
        this.mBorderStrokeWidth = mBorderStrokeWidth;
    }
    ...
    public void setmTickStrokeWidth(int mTickStrokeWidth) {
        this.mTickStrokeWidth = mTickStrokeWidth;
    }
    ...
    private void drawCenter(Canvas canvas) {
        ...
        float radius = (mCenterPoint.x - mBorderStrokeWidth) * mScaleVal;
    ...
    public interface OnCheckedChangeListener {
        void onCheckedChanged(AnimatedCheckBox checkBox, boolean isChecked);
    }
}
